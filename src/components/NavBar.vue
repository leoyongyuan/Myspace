    ...
    <nav class="navbar navbar-dark bg-dark navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <ul class="navbar-nav" v-if="!$store.state.user.is_login">
                <li class="nav-item">
                <router-link class="nav-link active" ari    a-current="page" :to="{name:'login'}">登录</router-link>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav" v-else>
                <li class="nav-item">
                <router-link class="nav-link active" ari    a-current="page" :to="{name:'userprofile',params:{userId:$store.state.user.id}}"
